var _ = require("underscore"),
	...
	Strategy = require("passport-l10n").Strategy;
...
var API = function( options ){
	...
	passport.use(new Strategy({
		...
		callbackURL: "/auth/l10n/callback", // option?
...
API.prototype = {
	...
	auth: function(){
		if( arguments[1] ) {
			return passport.authenticate('l10n', arguments[0], arguments[1]);
		} else {
			return passport.authenticate('l10n', arguments[0]);
		}
	},
